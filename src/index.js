 ...
 */
module.exports.getImagesFromAlbumUrl = async function (albumUrl) {
 ...
 * @returns - Body/data of the URL
 */
module.exports.getHtmlContent = async function (url) {
 ...
 */
module.exports.getImagesFromAlbumHtml = async function (html) {
  const imageUrls = []
 ...
 */
module.exports.getHigherResImgUrl = function (lowResImgUrl) {
